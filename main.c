...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/12 14:33:30 by irivero-          #+#    #+#             */
/*   Updated: 2023/05/12 15:07:35 by irivero-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	strcpy(s34, "rocky");
	strcpy(s35, "ernest");
	printf("%p\n", ft_memcpy(s34, s35,4));//FT_MEMCCPY
	printf("%s\n", s34);
	printf("\n");
	printf("[memccpy]\n");
	char s36[50], s37[50];
	...
	printf("[ft_strlcpy]\n");
	char s1 [50];
	printf("%zu\n", ft_strlcpy(s1, "life", 5));//FT_STRCPY
	printf("\n");
	char s2 [50];
	printf("[strlcpy]\n");
	printf("%s\n", strncpy(s2, "life", 5));
	...
	printf("[ft_strncpy]\n");
	char s3 [50];
	printf("%zu\n", ft_strlcpy(s3, "metropolis", 3));//FT_STRNCPY
	printf("\n");
	printf("[strncpy]\n");
	char s4 [50];
	...
	strcpy(s19, "bon");
	char *p5;
	p5 = ft_strnstr(s18, s19, 50);//FT_STRSTR
	printf("%s\n", p5);
	char s180[50], s190[50];
	strcpy(s180, "ozarabozaraboze");
	strcpy(s190, "ozaraboze");
	char *p50;
	p50 = ft_strnstr(s180, s190, 50);//FT_STRSTR
	printf("%s\n", p50);
	...
	char *p80;
	p80 = strstr(s240, s250);
	printf("%s\n", p80);
	printf("-----------------------------------------------------------------------------\n");
	printf("[ft_strcmp]\n");
	printf("%d\n", ft_strncmp("hola", "hol", 50));//FT_STRCMP	
	printf("\n");
	printf("[strcmp]\n");
	printf("%d\n", strcmp("hola", "hol"));	
	printf("-----------------------------------------------------------------------------\n");
